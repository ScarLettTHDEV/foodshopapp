...
import '../jsons/json_file.dart';

class DetailPageBuger extends StatefulWidget {
  String imgthumbnail;
  String name;

  DetailPageBuger({required this.imgthumbnail, required this.name, Key? key})
      : super(key: key);

  @override
  State<DetailPageBuger> createState() => _DetailPageBugerState();
}

class _DetailPageBugerState extends State<DetailPageBuger> {
  int number = 1;
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage(widget.imgthumbnail),
                      fit: BoxFit.cover),
                ),
                child: Padding(
